...
public class CountMethods {
    Triangle arrayTriangles[];

    public CountMethods() {
        this.arrayTriangles = new Triangle[0];
    }
...
//    }
    ...
    public double countPerimeter(Triangle[] triangles, Dot dotA, Dot dotB, Dot dotC){
...
//    public double countCoordinateX (Triangle[] triangles, Dot dotA, Dot dotB){
//        return dotA - dotB;
//    }

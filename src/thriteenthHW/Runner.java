package thriteenthHW;

import thriteenthHW.taxiPark.*;
import thriteenthHW.vehicles.*;
...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        taxiPark.sortByFuelConsumptionWithLambda(vehicles);
        taxiPark.sortByFuelConsumptionWithComparator(vehicles);
        taxiPark.sortByFuelConsumptionWithReference(vehicles);
